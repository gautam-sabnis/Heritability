...
args$input <- "vame_12k.csv"
args$yaml <- "vame_12k.yaml"
name <- "vame_12k_2023-04-03"
args$basedir <- "example"
...
fwrite(annotations, paste0(args$basedir, "/annotations.csv"), row.names = FALSE, col.names = TRUE, sep = ",")
